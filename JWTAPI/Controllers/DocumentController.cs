...
namespace JWTAPI.Controllers
{
    ...
    public class DocumentController : ControllerBase
    {
        ...
        public DocumentController(IDocumentService db, IMapper mapper)
        {
            _db = db;
            _mapper = mapper;
        }
        ...
        [HttpPost]
        [Authorize]
        public async Task<IActionResult> Post([FromBody] DocumentPost model)
        {
            var cmodel = _mapper.Map<DocumentPost, Document>(model);
        ...
        [HttpPut]
        [Authorize]
        public async Task<IActionResult> Put([FromBody] DocumentPost model)
        {
            var cmodel = _mapper.Map<DocumentPost, Document>(model);
